...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'parking_space.create': {
    roles: ['business-owner', 'customer'],
    key: 'new-parking-space-posted',
    tenantPath: ['company', 'parking_space'],
    userPath: [],
  },
  'parking_space.update': {
    roles: ['business-owner', 'customer'],
    key: 'parking-space-updated',
    tenantPath: ['company', 'parking_space'],
    userPath: [],
  },
  'parking_space.delete': {
    roles: ['business-owner', 'customer'],
    key: 'parking-space-deleted',
    tenantPath: ['company', 'parking_space'],
    userPath: [],
  },
  'booking.create': {
    roles: ['parking-space-provider'],
    key: 'new-booking-created',
    tenantPath: ['company', 'parking_space', 'booking'],
    userPath: [],
  },
  'booking.delete': {
    roles: ['parking-space-provider'],
...
const ownerRoles: string[] = ['parking-space-provider'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['business-owner', 'parking-space-provider'];
