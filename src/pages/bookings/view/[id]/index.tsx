          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                {hasAccess('parking_space', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Parking Space"
                    text={
                      <Link as={NextLink} href={`/parking-spaces/view/${data?.parking_space?.id}`}>
                        {data?.parking_space?.location}
                      </Link>
                    }
                  />
                )}
