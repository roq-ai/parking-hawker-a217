...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function getParkingSpaces() {
    ...
    const response = await prisma.parking_space
      .withAuthorization({
        roqUserId,
      ...
      .findManyPaginated({
        ...convertQueryToPrismaUtil(query, 'parking_space'),
        take: limit,
        skip: offset,
        ...(order?.length && {
  ...
  async function createParkingSpace() {
    ...
    const data = await prisma.parking_space.create({
      data: body,
    });
